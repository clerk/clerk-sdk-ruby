...
module Clerk
  ...
  class RedirectUrls
    ...
    def list(paginated: nil, limit: nil, offset: nil, retries: nil, timeout_ms: nil)
      ...
      query_params = Utils.get_query_params(Models::Operations::ListRedirectURLsRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Crystalline::Array.new(Models::Components::RedirectURL))
          response = Models::Operations::ListRedirectURLsResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            redirect_url_list: obj
          )
    ...
    def create(request: nil, retries: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::RedirectURL)
          response = Models::Operations::CreateRedirectURLResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            redirect_url: obj
    ...
    def get(id:, retries: nil, timeout_ms: nil)
      ...
      url = Utils.generate_url(
        Models::Operations::GetRedirectURLRequest,
        base_url,
        '/redirect_urls/{id}',
        request
      )
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::RedirectURL)
          response = Models::Operations::GetRedirectURLResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            redirect_url: obj
    ...
    def delete(id:, retries: nil, timeout_ms: nil)
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::DeleteRedirectURLRequest,
        base_url,
        '/redirect_urls/{id}',
        request
      )
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response = Models::Operations::DeleteRedirectURLResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            deleted_object: obj
