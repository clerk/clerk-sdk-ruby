...
module Clerk
  ...
  class AllowlistIdentifiers
    ...
    def list(paginated: nil, limit: nil, offset: nil, retries: nil, timeout_ms: nil)
      ...
      query_params = Utils.get_query_params(Models::Operations::ListAllowlistIdentifiersRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Crystalline::Array.new(Models::Components::AllowlistIdentifier))
          response = Models::Operations::ListAllowlistIdentifiersResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            allowlist_identifier_list: obj
          )
      ...
      elsif Utils.match_status_code(http_response.status, ['401', '402'])
        if Utils.match_content_type(content_type, 'application/json')
          http_response = @sdk_configuration.hooks.after_success(
            hook_ctx: SDKHooks::AfterSuccessHookContext.new(
              hook_ctx: hook_ctx
    ...
    def create(request: nil, retries: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::AllowlistIdentifier)
          response = Models::Operations::CreateAllowlistIdentifierResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            allowlist_identifier: obj
          )
    ...
    def delete(identifier_id:, retries: nil, timeout_ms: nil)
      ...
      url = Utils.generate_url(
        Models::Operations::DeleteAllowlistIdentifierRequest,
        base_url,
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response = Models::Operations::DeleteAllowlistIdentifierResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            deleted_object: obj
      ...
      elsif Utils.match_status_code(http_response.status, ['402', '404'])
        if Utils.match_content_type(content_type, 'application/json')
          http_response = @sdk_configuration.hooks.after_success(
            hook_ctx: SDKHooks::AfterSuccessHookContext.new(
              hook_ctx: hook_ctx
