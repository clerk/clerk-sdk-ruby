  ...
  class SignUps
    ...
    def get(id:, retries: nil, timeout_ms: nil)
      ...
      url = Utils.generate_url(
        Models::Operations::GetSignUpRequest,
        base_url,
        '/sign_ups/{id}',
        request
      )
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::SignUp)
          response = Models::Operations::GetSignUpResponse.new(
    ...
    def update(id:, body: nil, retries: nil, timeout_ms: nil)
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::UpdateSignUpRequest,
        base_url,
        '/sign_ups/{id}',
        request
      )
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::SignUp)
          response = Models::Operations::UpdateSignUpResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            sign_up: obj
