...
module Clerk
  ...
  class Users
    ...
    def remove_password(user_id:, body: nil, retries: nil, timeout_ms: nil, http_headers: nil)
      ...
      request = Models::Operations::RemoveUserPasswordRequest.new(
        user_id: user_id,
        body: body
      )
      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::RemoveUserPasswordRequest,
        base_url,
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::User)
          response = Models::Operations::RemoveUserPasswordResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            user: obj
    ...
    def list_trusted_devices(user_id:, retries: nil, timeout_ms: nil, http_headers: nil)
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::ListUserTrustedDevicesRequest,
        base_url,
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::TrustedDeviceList)
          response = Models::Operations::ListUserTrustedDevicesResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            trusted_device_list: obj
          )
    ...
    def revoke_trusted_device(user_id:, trusted_device_id:, retries: nil, timeout_ms: nil, http_headers: nil)
      ...
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::RevokeUserTrustedDeviceRequest,
        base_url,
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::TrustedDevice)
          response = Models::Operations::RevokeUserTrustedDeviceResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            trusted_device: obj
