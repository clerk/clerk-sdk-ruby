...
module Clerk
  ...
  class OrganizationPermissions
    ...
    def list(query: nil, order_by: nil, limit: nil, offset: nil, retries: nil, timeout_ms: nil)
      ...
      url = "#{base_url}/organization_permissions"
      headers = {}
      
      query_params = Utils.get_query_params(Models::Operations::ListOrganizationPermissionsRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::Permissions)
          response = Models::Operations::ListOrganizationPermissionsResponse.new(
    ...
    def create(request:, retries: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::Permission)
          response = Models::Operations::CreateOrganizationPermissionResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            permission: obj
      ...
      elsif Utils.match_status_code(http_response.status, ['400', '401', '402', '404', '422'])
        if Utils.match_content_type(content_type, 'application/json')
          http_response = @sdk_configuration.hooks.after_success(
            hook_ctx: SDKHooks::AfterSuccessHookContext.new(
              hook_ctx: hook_ctx
    ...
    def get(permission_id:, retries: nil, timeout_ms: nil)
      ...
      url = Utils.generate_url(
        Models::Operations::GetOrganizationPermissionRequest,
        base_url,
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::Permission)
          response = Models::Operations::GetOrganizationPermissionResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            permission: obj
    ...
    def update(body:, permission_id:, retries: nil, timeout_ms: nil)
      ...
      request = Models::Operations::UpdateOrganizationPermissionRequest.new(
        permission_id: permission_id,
        body: body
      )
      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::UpdateOrganizationPermissionRequest,
        base_url,
        '/organization_permissions/{permission_id}',
        request
      )
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::Permission)
          response = Models::Operations::UpdateOrganizationPermissionResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            permission: obj
    ...
    def delete(permission_id:, retries: nil, timeout_ms: nil)
      ...
      request = Models::Operations::DeleteOrganizationPermissionRequest.new(
        permission_id: permission_id
      )
      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::DeleteOrganizationPermissionRequest,
        base_url,
        '/organization_permissions/{permission_id}',
        request
      )
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response = Models::Operations::DeleteOrganizationPermissionResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            deleted_object: obj
