  ...
  module Models
    module Components
      ...
      class SchemasCommerceSubscriptionItemNextPaymentTotals
        ...
        field :credits, Crystalline::Nilable.new(Models::Components::SchemasCommerceSubscriptionItemNextPaymentCredits), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('credits') } }

        field :discounts, Crystalline::Nilable.new(Models::Components::SchemasCommerceSubscriptionItemNextPaymentDiscounts), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('discounts') } }
