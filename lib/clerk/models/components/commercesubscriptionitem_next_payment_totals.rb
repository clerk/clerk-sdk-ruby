...
module Clerk
  module Models
    module Components
      ...
      class CommerceSubscriptionItemNextPaymentTotals
        ...
        field :credits, Crystalline::Nilable.new(Models::Components::CommerceSubscriptionItemNextPaymentCredits), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('credits') } }

        field :discounts, Crystalline::Nilable.new(Models::Components::CommerceSubscriptionItemNextPaymentDiscounts), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('discounts') } }
