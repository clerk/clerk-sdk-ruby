  ...
  module Models
    module Components
      ...
      class OrganizationMembershipOrganization
        ...
        field :object, Models::Components::OrganizationMembershipObjectOrganization, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('object'), required: true, 'decoder': Utils.enum_from_string(Models::Components::OrganizationMembershipObjectOrganization, false) } }
        ...
        def initialize(object:, id:, name:, slug:, has_image:, max_allowed_memberships:, admin_delete_enabled:, public_metadata:, created_at:, updated_at:, image_url: nil, members_count: nil, missing_member_with_elevated_permissions: nil, pending_invitations_count: nil, private_metadata: nil, created_by: nil, last_active_at: nil)
          @object = object
          @id = id
          @name = name
          @slug = slug
