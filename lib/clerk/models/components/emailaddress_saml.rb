  ...
  module Models
    module Components
      ...
      class EmailAddressSAML
        ...
        field :error, Crystalline::Nilable.new(Models::Components::EmailAddressVerificationSamlClerkError), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('error') } }
