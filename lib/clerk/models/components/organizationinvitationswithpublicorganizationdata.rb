  ...
  module Models
    module Components
      ...
      class OrganizationInvitationsWithPublicOrganizationData
        ...
        field :data, Crystalline::Array.new(Models::Components::OrganizationInvitationWithPublicOrganizationData), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('data'), required: true } }
