  ...
  module Models
    module Components
      ...
      class MachineWithoutScopedMachines
        ...
        field :object, Models::Components::MachineWithoutScopedMachinesObject, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('object'), required: true, 'decoder': ::Clerk::Utils.enum_from_string(Models::Components::MachineWithoutScopedMachinesObject, false) } }
        ...
        def initialize(object:, id:, name:, instance_id:, created_at:, updated_at:, default_token_ttl: 3600)
          @object = object
          @id = id
          @name = name
