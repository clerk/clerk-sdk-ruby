  ...
  module Models
    module Components
      ...
      class MachineWithoutScopedMachines
        ...
        field :object, Models::Components::MachineWithoutScopedMachinesObject, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('object'), required: true, 'decoder': Utils.enum_from_string(Models::Components::MachineWithoutScopedMachinesObject, false) } }
