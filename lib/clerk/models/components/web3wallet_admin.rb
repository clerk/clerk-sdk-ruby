  ...
  module Models
    module Components
      ...
      class Web3WalletAdmin
        ...
        field :strategy, Models::Components::Web3WalletVerificationAdminStrategy, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('strategy'), required: true, 'decoder': Utils.enum_from_string(Models::Components::Web3WalletVerificationAdminStrategy, false) } }
