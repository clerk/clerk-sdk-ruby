...
class Clerk::Models::Components::SchemasSAMLConnectionSAMLConnection1
...
class Clerk::Models::Components::SchemasSAMLConnectionSAMLConnection1
  ...
  def sp_entity_id=(str_); end
  def sp_metadata_url(); end
  def sp_metadata_url=(str_); end
  def active(); end
  def active=(str_); end
  def provider(); end
  def provider=(str_); end
  def user_count(); end
  def user_count=(str_); end
  def sync_user_attributes(); end
  def sync_user_attributes=(str_); end
  ...
  def enterprise_connection_id(); end
  def enterprise_connection_id=(str_); end
end