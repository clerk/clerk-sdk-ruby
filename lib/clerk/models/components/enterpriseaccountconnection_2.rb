...
module Clerk
  module Models
    module Components
      ...
      class EnterpriseAccountConnection2
        ...
        def initialize(id:, protocol:, provider:, name:, domains:, active:, sync_user_attributes:, allow_subdomains:, allow_idp_initiated:, disable_additional_identifications:, created_at:, updated_at:, logo_public_url: nil, domain: nil)
          @id = id
          @protocol = protocol
          @provider = provider
          @name = name
