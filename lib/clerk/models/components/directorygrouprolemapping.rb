  ...
  module Models
    module Components
      ...
      class DirectoryGroupRoleMapping
        ...
        field :object, Models::Components::DirectoryGroupRoleMappingObject, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('object'), required: true, 'decoder': ::Clerk::Utils.enum_from_string(Models::Components::DirectoryGroupRoleMappingObject, false) } }
        ...
        def initialize(object:, id:, directory_id:, scim_directory_id:, directory_group_id:, scim_group_id:, directory_group_display_name:, scim_group_display_name:, precedence:, created_at:, updated_at:, role: nil)
          @object = object
          @id = id
