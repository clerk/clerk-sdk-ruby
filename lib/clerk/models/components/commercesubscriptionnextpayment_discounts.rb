  ...
  module Models
    module Components
      ...
      class CommerceSubscriptionNextPaymentDiscounts
        ...
        field :proration, Crystalline::Nilable.new(Models::Components::CommerceSubscriptionNextPaymentDiscountsProration), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('proration'), required: true } }
