  ...
  module Models
    module Components
      ...
      class EmailAddress
        ...
        field :verification, Crystalline::Nilable.new(Crystalline::Union.new(Models::Components::EmailAddressOTP, Models::Components::EmailAddressAdmin, Models::Components::FromOAuth, Models::Components::EmailAddressTicket, Models::Components::EmailAddressSAML, Models::Components::EmailLink, Models::Components::VerificationSCIMSCIM)), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('verification'), required: true }, 'discriminator': 'object', 'discriminator_mapping': { 'verification_otp' => Models::Components::EmailAddressOTP, 'verification_admin' => Models::Components::EmailAddressAdmin, 'verification_from_oauth' => Models::Components::FromOAuth, 'verification_ticket' => Models::Components::EmailAddressTicket, 'verification_saml' => Models::Components::EmailAddressSAML, 'verification_email_link' => Models::Components::EmailLink, 'verification_scim' => Models::Components::VerificationSCIMSCIM } }
