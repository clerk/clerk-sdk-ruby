  ...
  module Models
    module Components
      ...
      class Invitation
        ...
        field :object, Models::Components::InvitationObject, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('object'), required: true, 'decoder': ::Clerk::Utils.enum_from_string(Models::Components::InvitationObject, false) } }
        ...
        field :status, Models::Components::InvitationStatus, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('status'), required: true, 'decoder': ::Clerk::Utils.enum_from_string(Models::Components::InvitationStatus, false) } }
