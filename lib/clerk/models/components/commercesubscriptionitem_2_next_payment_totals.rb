...
module Clerk
  module Models
    module Components
      ...
      class CommerceSubscriptionItem2NextPaymentTotals
        ...
        field :credits, Crystalline::Nilable.new(Models::Components::CommerceSubscriptionItem2NextPaymentCredits), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('credits') } }

        field :discounts, Crystalline::Nilable.new(Models::Components::CommerceSubscriptionItem2NextPaymentDiscounts), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('discounts') } }
