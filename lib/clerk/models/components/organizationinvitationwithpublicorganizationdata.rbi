...
class Clerk::Models::Components::OrganizationInvitationWithPublicOrganizationData
...
class Clerk::Models::Components::OrganizationInvitationWithPublicOrganizationData
  ...
  def inviter_id(); end
  def inviter_id=(str_); end
  def public_inviter_data(); end
  def public_inviter_data=(str_); end
  def status(); end
  def status=(str_); end
  ...
  def public_organization_data=(str_); end
end