  ...
  module Models
    module Components
      ...
      class EmailAddressOTP
        ...
        field :strategy, Models::Components::EmailAddressVerificationOtpStrategy, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('strategy'), required: true, 'decoder': Utils.enum_from_string(Models::Components::EmailAddressVerificationOtpStrategy, false) } }
