  ...
  module Models
    module Components
      ...
      class OrganizationMembershipPublicUserData
        ...
        def initialize(user_id:, image_url:, has_image:, first_name: nil, last_name: nil, profile_image_url: nil, banned: nil, deprovisioned: nil, identifier: nil, username: nil)
          @user_id = user_id
          @image_url = image_url
          @has_image = has_image
