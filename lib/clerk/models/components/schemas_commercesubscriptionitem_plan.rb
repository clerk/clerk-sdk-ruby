  ...
  module Models
    module Components
      ...
      class SchemasCommerceSubscriptionItemPlan
        ...
        field :object, Models::Components::SchemasCommerceSubscriptionItemObjectCommercePlan, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('object'), required: true, 'decoder': ::Clerk::Utils.enum_from_string(Models::Components::SchemasCommerceSubscriptionItemObjectCommercePlan, false) } }
        ...
        field :fee, Crystalline::Nilable.new(Models::Components::SchemasCommerceSubscriptionItemFee), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('fee'), required: true } }

        field :annual_monthly_fee, Crystalline::Nilable.new(Models::Components::SchemasCommerceSubscriptionItemAnnualMonthlyFee), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('annual_monthly_fee'), required: true } }

        field :annual_fee, Crystalline::Nilable.new(Models::Components::SchemasCommerceSubscriptionItemAnnualFee), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('annual_fee'), required: true } }
