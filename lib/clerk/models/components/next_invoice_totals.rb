  ...
  module Models
    module Components
      ...
      class NextInvoiceTotals
        ...
        field :credits, Crystalline::Nilable.new(Models::Components::NextInvoiceCredits), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('credits') } }

        field :discounts, Crystalline::Nilable.new(Models::Components::NextInvoiceDiscounts), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('discounts') } }
