...
module Clerk
  module Models
    module Components
      ...
      class SchemasCommercePerUnitTotal
        ...
        field :tiers, Crystalline::Array.new(Models::Components::SchemasCommercePerUnitTotalTier), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('tiers'), required: true } }
