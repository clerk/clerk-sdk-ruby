  ...
  module Models
    module Components
      ...
      class TrustedDevice
        ...
        field :object, Models::Components::TrustedDeviceObject, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('object'), required: true, 'decoder': ::Clerk::Utils.enum_from_string(Models::Components::TrustedDeviceObject, false) } }
