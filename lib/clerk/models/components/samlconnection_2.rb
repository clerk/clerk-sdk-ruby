  ...
  module Models
    module Components
      ...
      class SAMLConnection2
        ...
        field :object, Models::Components::SAMLConnectionObject2, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('object'), required: true, 'decoder': ::Clerk::Utils.enum_from_string(Models::Components::SAMLConnectionObject2, false) } }
