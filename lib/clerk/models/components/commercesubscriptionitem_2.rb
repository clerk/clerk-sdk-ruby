  ...
  module Models
    module Components
      ...
      class CommerceSubscriptionItem2
        ...
        field :object, Models::Components::CommerceSubscriptionItem2ObjectCommerceSubscriptionItem, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('object'), required: true, 'decoder': ::Clerk::Utils.enum_from_string(Models::Components::CommerceSubscriptionItem2ObjectCommerceSubscriptionItem, false) } }
        ...
        field :status, Models::Components::CommerceSubscriptionItem2Status, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('status'), required: true, 'decoder': ::Clerk::Utils.enum_from_string(Models::Components::CommerceSubscriptionItem2Status, false) } }
        ...
        field :plan_period, Models::Components::CommerceSubscriptionItem2PlanPeriod, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('plan_period'), required: true, 'decoder': ::Clerk::Utils.enum_from_string(Models::Components::CommerceSubscriptionItem2PlanPeriod, false) } }
        ...
        field :plan, Crystalline::Nilable.new(Models::Components::CommerceSubscriptionItem2Plan), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('plan'), required: true } }
        ...
        field :amount, Crystalline::Nilable.new(Models::Components::CommerceSubscriptionItem2Amount), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('amount') } }
        ...
        field :next_payment, Crystalline::Nilable.new(Models::Components::CommerceSubscriptionItem2NextPayment), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('next_payment') } }
        # The payer associated with this subscription.
        field :payer, Crystalline::Nilable.new(Models::Components::PayerCommercePayer), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('payer') } }
