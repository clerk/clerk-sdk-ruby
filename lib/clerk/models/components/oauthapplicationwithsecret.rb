  ...
  module Models
    module Components
      ...
      class OAuthApplicationWithSecret
        ...
        field :object, Models::Components::OAuthApplicationWithSecretObject, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('object'), required: true, 'decoder': Utils.enum_from_string(Models::Components::OAuthApplicationWithSecretObject, false) } }
