  ...
  module Models
    module Components
      ...
      class FromOAuth
        ...
        field :error, Crystalline::Nilable.new(Models::Components::VerificationFromOauthClerkError), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('error') } }
        ...
        def initialize(status:, strategy:, object: nil, expire_at: nil, attempts: nil, error: nil, verified_at_client: nil)
          @status = status
          @strategy = strategy
          @object = object
          @expire_at = expire_at
