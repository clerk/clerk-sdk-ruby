...
module Clerk
  module Models
    module Components
      ...
      class FeatureResponse2
        
        include Crystalline::MetadataFields

        # String representing the object's type. Objects of the same type share the same value.
        field :object, Models::Components::FeatureResponse2Object, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('object'), required: true, 'decoder': ::Clerk::Utils.enum_from_string(Models::Components::FeatureResponse2Object, false) } }
        ...
        def initialize(object:, id:, name:, description:, slug:, avatar_url:)
          @object = object
          @id = id
          @name = name
