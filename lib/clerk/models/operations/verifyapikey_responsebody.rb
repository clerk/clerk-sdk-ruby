  ...
  module Models
    module Operations
      ...
      class VerifyApiKeyResponseBody
        ...
        field :object, Models::Operations::VerifyApiKeyObject, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('object'), required: true, 'decoder': Utils.enum_from_string(Models::Operations::VerifyApiKeyObject, false) } }
