  ...
  module Models
    module Operations
      ...
      class RevokeApiKeyResponseBody
        ...
        field :object, Models::Operations::RevokeApiKeyObject, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('object'), required: true, 'decoder': Utils.enum_from_string(Models::Operations::RevokeApiKeyObject, false) } }
