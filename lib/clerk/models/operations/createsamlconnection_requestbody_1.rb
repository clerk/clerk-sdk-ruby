...
module Clerk
  module Models
    module Operations
      ...
      class CreateSAMLConnectionRequestBody1
        ...
        field :attribute_mapping, Crystalline::Nilable.new(Models::Operations::CreateSAMLConnectionAttributeMapping1), { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('attribute_mapping') } }
