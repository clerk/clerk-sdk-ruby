  ...
  module Models
    module Operations
      ...
      class CreateAdminPortalLinkTokenResponseBody
        ...
        field :object, Models::Operations::CreateAdminPortalLinkTokenObject, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('object'), required: true, 'decoder': ::Clerk::Utils.enum_from_string(Models::Operations::CreateAdminPortalLinkTokenObject, false) } }
        ...
        def initialize(object:, id:, admin_portal_link_id:, instance_id:, token:, revoked:, expired:, created_at:, updated_at:, organization_id: nil, it_contact_id: nil, scopes: nil, revocation_reason: nil, expiration: nil)
          @object = object
          @id = id
