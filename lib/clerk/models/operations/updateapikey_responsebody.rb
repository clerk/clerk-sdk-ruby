  ...
  module Models
    module Operations
      ...
      class UpdateApiKeyResponseBody
        ...
        field :object, Models::Operations::UpdateApiKeyObject, { 'format_json': { 'letter_case': ::Clerk::Utils.field_name('object'), required: true, 'decoder': Utils.enum_from_string(Models::Operations::UpdateApiKeyObject, false) } }
