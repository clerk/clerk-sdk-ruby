  ...
  module Models
    module Operations
      ...
      class GetCommercePlanListRequest
        ...
        field :payer_type, Crystalline::Nilable.new(Models::Operations::GetCommercePlanListPayerType), { 'query_param': { 'field_name': 'payer_type', 'style': 'form', 'explode': true } }
        ...
        def initialize(paginated: nil, payer_type: nil, limit: 10, offset: 0)
          @paginated = paginated
