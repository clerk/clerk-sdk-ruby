  ...
  module Models
    module Operations
      ...
      class SetUserPasswordCompromisedRequest
        ...
        field :body, Crystalline::Nilable.new(Models::Operations::SetUserPasswordCompromisedRequestBody), { 'request': { 'media_type': 'application/json' } }

        
        def initialize(user_id:, body: nil)
          @user_id = user_id
          @body = body
        end
