  ...
  module Models
    module Operations
      ...
      class CreateApiKeyResponseBody
        ...
        def initialize(object:, id:, type:, subject:, name:, scopes:, secret:, revoked:, expired:, created_at:, updated_at:, claims: nil, revocation_reason: nil, expiration: nil, created_by: nil, last_used_at: nil, description: nil)
          @object = object
          @id = id
          @type = type
          @subject = subject
