  ...
  module Models
    module Operations
      ...
      class UpdateOrganizationMembershipMetadataRequest
        ...
        field :body, Crystalline::Nilable.new(Models::Operations::UpdateOrganizationMembershipMetadataRequestBody), { 'request': { 'media_type': 'application/json' } }

        
        def initialize(organization_id:, user_id:, body: nil)
