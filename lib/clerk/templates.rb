    ...
    def preview(template_type:, slug:, body: nil, retries: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Operations::PreviewTemplateResponseBody)
          response = Models::Operations::PreviewTemplateResponse.new(
