  ...
  class ActorTokens
    ...
    def create(request: nil, retries: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::ActorToken)
          response = Models::Operations::CreateActorTokenResponse.new(
    ...
    def revoke(actor_token_id:, retries: nil, timeout_ms: nil)
      ...
      url = Utils.generate_url(
        Models::Operations::RevokeActorTokenRequest,
        base_url,
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::ActorToken)
          response = Models::Operations::RevokeActorTokenResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            actor_token: obj
