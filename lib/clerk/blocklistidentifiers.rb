...
module Clerk
  ...
  class BlocklistIdentifiers
    ...
    def list(retries: nil, timeout_ms: nil)
      ...
      url = "#{base_url}/blocklist_identifiers"
      headers = {}
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::BlocklistIdentifiers)
          response = Models::Operations::ListBlocklistIdentifiersResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            blocklist_identifiers: obj
          )
    ...
    def create(request: nil, retries: nil, timeout_ms: nil)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::BlocklistIdentifier)
          response = Models::Operations::CreateBlocklistIdentifierResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            blocklist_identifier: obj
          )
    ...
    def delete(identifier_id:, retries: nil, timeout_ms: nil)
      ...
      url = Utils.generate_url(
        Models::Operations::DeleteBlocklistIdentifierRequest,
        base_url,
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response = Models::Operations::DeleteBlocklistIdentifierResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            deleted_object: obj
