...
module Clerk
  ...
  class OauthAccessTokens
    ...
    def verify(request:, retries: nil, timeout_ms: nil)
      ...
      url = "#{base_url}/oauth_applications/access_tokens/verify"
      headers = {}
      ...
      hook_ctx = SDKHooks::HookContext.new(
        ...
        base_url: base_url,
        oauth2_scopes: nil,
        operation_id: 'verifyOAuthAccessToken',
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Crystalline::Union.new(Models::Operations::ClerkIdpOauthAccessToken, Models::Operations::ResponseBody))
          response = Models::Operations::VerifyOAuthAccessTokenResponse.new(
        ...
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Errors::VerifyOAuthAccessTokenBadRequestError)
        ...
        if Utils.match_content_type(content_type, 'application/json')
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Errors::VerifyOAuthAccessTokenNotFoundError)
          obj.raw_response = http_response
          raise obj
        else
          raise ::Clerk::Models::Errors::APIError.new(status_code: http_response.status, body: http_response.env.response_body, raw_response: http_response), 'Unknown content type received'
