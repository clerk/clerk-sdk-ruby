...
module Clerk
  ...
  module StepUp
    module Preset
      STRICT_MFA = {after_minutes: 10, level: :multi_factor}.freeze
      STRICT = {after_minutes: 10, level: :second_factor}.freeze
      MODERATE = {after_minutes: 60, level: :second_factor}.freeze
      LAX = {after_minutes: 1440, level: :second_factor}.freeze
    end
